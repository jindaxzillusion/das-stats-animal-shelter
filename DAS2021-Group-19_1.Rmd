...
knitr::opts_chunk$set(echo = FALSaE, eval=TRUE,warning = FALSE,message = FALSE, comment = NA)
library(ggplot2)
library(dplyr)
library(sjPlot)
library(stats)
...
roc_plot
```
$$\widehat{on~time} ~=~ 33.613 ~+~ 0.197~\cdot~ I_{Surrender}~ (i) ~+~ 0.283 ~\cdot~ I_{Stray}~ (i) ~+~
