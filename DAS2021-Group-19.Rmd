...
s1 <- summary(mod.nbfull) #smaller deviance than poi full: 2156.3
s2 <- summary(mod.nb6) # smaller deviance than poi: 2153.4
s1$deviance - s2$deviance < qchisq(df=2,0.95)

```
Difference in deviance of nested models is less than the chi-square, therefore fit is good. *please check this*
